...
import heroImage from "../../../images/detail/mobile/image-bookmark-hero@2x.jpg";
import heroImageTablet from "../../../images/detail/tablet/image-bookmark-hero@2x.jpg";
import heroImageDesktop from "../../../images/detail/desktop/image-bookmark-hero@2x.jpg";
  ...
  return (
    <main className="bookmark-container grid-container">
      <section className="project project-header-grid">
        ...
        <p className="heading project__heading ">Bookmark</p>
